...
def halvesies(numbers):
    ...
    the half::
        ...
        [0.5, 2.5]
    """
    return [float(numbers) / 2 for numbers in numbers if numbers]
...
def word_lengths(words):
    ...
    return [len(words) for words in words if words]
...
def duplicates(items):
    ...
    You should do this without changing the original list::
        ...
        ['apple', 'apple', 'berry']
    """
    return [i for items in items if items[i] == 1]
